**This is a Metal/graphics rendering crash related to the map view being deallocated improperly. It's a common issue with MapKit in SwiftUI sheets. Let's fix it by ensuring proper cleanup:**
